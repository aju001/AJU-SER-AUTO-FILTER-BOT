...
# Creator
CREATOR_NAME = os.environ.get("CREATOR_NAME", "𝗮𝗷𝘂")
CREATOR_USERNAME = os.environ.get("CREATOR_USERNAME", "ajukalex")

# Account
API_HASH = os.environ.get("API_HASH", "5b1d0992294a67cb54512a4fafeb0c88")
API_ID = os.environ.get("API_ID", "6170803")
# About Bot
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5515459324:AAFtLiYSASa5_Yi3PaEbXZxpXbcHWhzeEAI")
PICS = os.environ.get("PICS", "https://i.ibb.co/kQ98t1k/AJU.jpg")
# Database
DATABASE_NAME = os.environ.get("DATABASE_NAME", "AJU-SER-AUTO-FILTER-BOT")
...
CHANNELS = [int(ch) if search.search(ch) else ch for ch in os.environ.get("CHANNELS", "-1001361180870").split()]
LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001590063851")
GET_FILECHANNEL = os.environ.get("GET_FILECHANNEL", "-1001421928092")
